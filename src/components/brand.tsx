...
export function BrandMark({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "relative grid shrink-0 place-items-center overflow-hidden rounded-xl bg-gradient-to-br from-cyan-400 via-indigo-500 to-violet-600 text-white shadow-[0_8px_24px_rgba(34,211,238,0.35),inset_0_1px_0_rgba(255,255,255,0.35)]",
        className,
      )}
    >
      <svg viewBox="0 0 24 24" fill="none" className="h-[62%] w-[62%]">
        ...
        {/* spark */}
        <path d="M17.6 3.4l.45 1.15 1.15.45-1.15.45-.45 1.15-.45-1.15-1.15-.45 1.15-.45z" fill="#a5f3fc" />
      </svg>
    </span>
  );
}
