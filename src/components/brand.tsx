...
export function BrandMark({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "relative grid shrink-0 place-items-center overflow-hidden rounded-xl bg-gradient-to-br from-indigo-400 via-indigo-500 to-indigo-600 text-white shadow-[0_8px_24px_rgba(99,102,241,0.45),inset_0_1px_0_rgba(255,255,255,0.35)]",
        className,
      )}
    >
      <svg viewBox="0 0 24 24" fill="none" className="h-[62%] w-[62%]">
        ...
        <rect
          ...
          strokeWidth="0.7"
        />
        <rect x="10.2" y="7.6" width="3.6" height="0.9" rx="0.45" fill="#6366F1" opacity="0.95" />
        <rect x="10.2" y="9.2" width="2.6" height="0.9" rx="0.45" fill="#94a3b8" opacity="0.8" />
        {/* spark */}
        <path d="M17.6 3.4l.45 1.15 1.15.45-1.15.45-.45 1.15-.45-1.15-1.15-.45 1.15-.45z" fill="#c7d2fe" />
      </svg>
    </span>
  );
}
