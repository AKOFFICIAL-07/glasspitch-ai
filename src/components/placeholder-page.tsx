      ...
      >
        <div className="glass glass-hover relative w-full overflow-hidden p-10 sm:p-14">
          ...
          <div className="relative flex flex-col items-center">
            <span className="glass-soft grid h-16 w-16 place-items-center rounded-2xl text-indigo-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
              <Badge className="border-transparent bg-indigo-500/10 text-indigo-300">
