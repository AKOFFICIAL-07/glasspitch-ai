      ...
      >
        <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-800">Projects</h1>
            <p className="mt-2 text-[14px] text-slate-500">
              Every source README you’ve turned into a deck, grouped by project.
            </p>
          </div>
          <Link to="/dashboard">
        ...
        {projects === undefined ? (
          ...
          <div className="glass-soft mt-8 flex flex-col items-center gap-3 rounded-3xl px-6 py-16 text-center">
            ...
            <p className="max-w-sm text-[14px] leading-relaxed text-slate-500">
              No projects yet. Generate your first deck on the dashboard and it
              will appear here.
            </p>
            <Link to="/dashboard">
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <span className="glass-soft grid h-10 w-10 place-items-center rounded-xl text-indigo-500">
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <button
                          ...
                          className="grid h-7 w-7 place-items-center rounded-lg text-slate-300 opacity-0 transition hover:bg-rose-50 hover:text-rose-500 group-hover:opacity-100"
                        >
                  ...
                  <h3 className="mt-4 line-clamp-1 text-[16px] font-bold text-slate-800">
                    {project.name}
                  </h3>
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-white/70 pt-3.5">
                    ...
                    {latest ? (
                      ...
                      <span className="text-[11.5px] text-slate-300">no decks</span>
                    )}
                  </div>
                </motion.div>
              );
